...
public class DriverController implements KeyListener {
	...
	private static ImageIcon[] images = { new ImageIcon("Images\\PojazdZ.jpg"), new ImageIcon("Images\\liniaPoziomaZ.jpg"),
			new ImageIcon("Images\\liniaPionowaZ.jpg"), new ImageIcon("Images\\liniaDolLewoZ.jpg"), new ImageIcon("Images\\liniaDolPrawoZ.jpg"),
			new ImageIcon("Images\\liniaGoraLewoZ.jpg"), new ImageIcon("Images\\liniaGoraPrawoZ.jpg"), new ImageIcon("Images\\PojazdC.jpg"),
			new ImageIcon("Images\\liniaPoziomaC.jpg"), new ImageIcon("Images\\liniaPionowaC.jpg"), new ImageIcon("Images\\liniaDolLewoC.jpg"),
			new ImageIcon("Images\\liniaDolPrawoC.jpg"), new ImageIcon("Images\\liniaGoraLewoC.jpg"),
			new ImageIcon("Images\\liniaGoraPrawoC.jpg"), new ImageIcon("Images\\PojazdR.jpg"), new ImageIcon("Images\\liniaPoziomaR.jpg"),
			new ImageIcon("Images\\liniaPionowaR.jpg"), new ImageIcon("Images\\liniaDolLewoR.jpg"), new ImageIcon("Images\\liniaDolPrawoR.jpg"),
			new ImageIcon("Images\\liniaGoraLewoR.jpg"), new ImageIcon("Images\\liniaGoraPrawoR.jpg"), };
