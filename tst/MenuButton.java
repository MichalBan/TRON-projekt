...
public class MenuButton extends JButton {
	...
	static void switchBg() {
		if (GameWindow.background == "Images\\bg2.png") {
			GameWindow.background = "Images\\bg3.jpg";
		} else if (GameWindow.background == "Images\\bg.jpg") {
			GameWindow.background = "Images\\bg2.png";
		} else if (GameWindow.background == "Images\\bg3.jpg") {
			GameWindow.background = "Images\\bg.jpg";
		}
